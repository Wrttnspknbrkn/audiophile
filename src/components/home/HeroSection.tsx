        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center px-6 tablet:px-[197px] mt-12 tablet:mt-12">
              <p className="text-[14px] font-normal leading-[19px] tracking-[10px] uppercase mb-4 tablet:mb-6 text-audiophile-white opacity-50">{content.hero.subtitle}</p>
        ...
        <div className="max-w-[1110px] mx-auto px-0 relative">
          <div className="grid grid-cols-12 items-center h-[700px]">
            <div className="col-span-5 text-left pl-0 pr-[95px]">
              <p className="text-[14px] font-normal leading-[19px] tracking-[10px] uppercase mb-6 text-audiophile-white opacity-50">{content.hero.subtitle}</p>
