      ...
      <div className="max-w-[1110px] mx-auto px-6 md:px-10 lg:px-0">
        ...
        <div className="lg:hidden">
          ...
          <div className="text-center">
            <h2 className="mb-8 text-audiophile-black" dangerouslySetInnerHTML={{ __html: content.about.title }}>
            </h2>
            <p className="body">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-32 lg:items-center">
          ...
          <div className="text-left">
            <h2 className="text-[40px] font-bold leading-[44px] tracking-[1.43px] uppercase text-audiophile-black mb-8" dangerouslySetInnerHTML={{ __html: content.about.title }}>
            </h2>
