        ...
        <div className="bg-audiophile-orange rounded-lg overflow-hidden relative min-h-[600px] tablet:min-h-[720px] desktop:min-h-[560px]">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img
              ...
              alt=""
              className="absolute -top-[20px] left-1/2 transform -translate-x-1/2 w-[558px] h-[558px] opacity-[0.15] tablet:-top-[100px] desktop:-top-[100px] desktop:left-[-150px] desktop:transform-none desktop:w-[944px] desktop:h-[944px] desktop:opacity-[0.2]"
            />
          </div>
          ...
          <div className="relative h-full">
            ...
            <div className="hidden desktop:block desktop:h-full">
              <div className="desktop:grid desktop:grid-cols-2 desktop:h-full desktop:items-end">
                {/* Left Column - Speaker Image */}
                <div className="desktop:flex desktop:justify-center desktop:items-end desktop:pb-0 desktop:pl-[117px] desktop:h-full desktop:relative">
                  <div className="desktop:absolute desktop:bottom-0 desktop:flex desktop:justify-center desktop:w-full">
                    <ResponsiveImage
                      mobile="/assets/home/mobile/image-speaker-zx9.png"
                      tablet="/assets/home/tablet/image-speaker-zx9.png"
                      desktop="/assets/home/desktop/image-speaker-zx9.png"
                      alt="ZX9 Speaker"
                      className="desktop:w-[410px] desktop:h-[493px] desktop:object-contain"
                    />
                  </div>
                </div>

                {/* Right Column - Text Content */}
                <div className="desktop:flex desktop:flex-col desktop:justify-center desktop:text-left desktop:pr-[95px] desktop:h-full">
                  <div>
