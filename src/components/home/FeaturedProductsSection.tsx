        ...
        <div className="bg-audiophile-orange rounded-lg overflow-hidden relative min-h-[600px] md:min-h-[720px] lg:min-h-[560px]">
          ...
          <div className="absolute inset-0 overflow-hidden">
            <img
              ...
              alt=""
              className="absolute -top-[20px] left-1/2 transform -translate-x-1/2 w-[558px] h-[558px] opacity-80 md:-top-[100px] lg:-top-[40px] lg:-left-[150px] lg:transform-none lg:w-[944px] lg:h-[944px] lg:opacity-90"
            />
          </div>
          ...
          <div className="hidden lg:flex lg:items-center lg:h-[560px] lg:relative">
            ...
            <div className="flex-1 flex flex-col justify-center pr-[95px] pl-[100px] relative z-10">
